    ...
    <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 space-y-6 min-h-screen font-['Inter']">
      ...
      >
        <div className="space-y-3 text-[10px]">
          ...
          {selectedRegion?.description && (
            <div className="bg-neutral-50 p-2.5 rounded-xl border border-neutral-200">
              <span className="text-[8px] font-bold text-neutral-400 uppercase">Deskripsi Operasional</span>
              <p className="font-medium text-neutral-700">{selectedRegion?.description}</p>
            </div>
          )}
      ...
      >
        <form onSubmit={handleSubmitForm} className="space-y-3 text-[10px]">
          ...
          <div className="space-y-1">
            <label className="text-[9px] font-bold text-neutral-500 uppercase">Deskripsi Operasional</label>
            <textarea rows="2" placeholder="Catatan operasional wilayah..." value={formData.description} onChange={(e) => setFormData({...formData, description: e.target.value})} className="w-full bg-neutral-50 border border-neutral-200 rounded-xl px-3 py-2 text-[10px] font-medium resize-none" />
          </div>
