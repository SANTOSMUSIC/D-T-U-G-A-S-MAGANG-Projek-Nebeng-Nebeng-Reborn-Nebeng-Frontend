...
export default function RegionsManagement() {
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 space-y-6 min-h-screen font-['Inter']">
      ...
      {/* DATA TABLE DENGAN EFEK HALUS SAAT GANTI HALAMAN */}
                  ...
                  <tr key={region.id} className="hover:bg-gray-50/50">
                    <td className="py-3.5 px-5">
                      <div className="flex items-center space-x-2.5">
                        <div className="p-2 bg-[#66CDAA]/10 text-[#66CDAA] rounded-xl font-bold">
                          <MapPin size={14} />
                        </div>
                        <div>
                    ...
                    <td className="py-3.5 px-5">
                      <div className="flex items-center justify-center gap-1.5">
                        <button onClick={() => handleOpenDetailModal(region)} className="p-1.5 bg-[#66CDAA]/10 text-[#66CDAA] rounded-lg cursor-pointer">
                          <Eye size={13} />
                        </button>
      ...
      >
        <div className="space-y-3 text-[10px]">
          ...
          <button onClick={() => setIsDetailModalOpen(false)} className="w-full py-2 bg-[#66CDAA] hover:bg-[#4FBF99] text-white text-[10px] font-bold rounded-full cursor-pointer transition">
            Tutup
          </button>
        </div>
      </BaseModal>
      ...
      >
        <form onSubmit={handleSubmitForm} className="space-y-3 text-[10px]">
          ...
          <div className="space-y-1">
            <label className="text-[9px] font-bold text-[#66CDAA] uppercase flex items-center gap-1">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="px-3 py-2 bg-neutral-800 hover:bg-neutral-900 text-white font-bold rounded-xl flex items-center gap-1 cursor-pointer disabled:opacity-50"
              >
          ...
          <div className="space-y-1 bg-neutral-50 p-3 rounded-xl border border-neutral-200">
            <div className="flex justify-between items-center mb-1">
              ...
              <span className="font-bold text-[#66CDAA] text-[11px] font-mono">
            ...
            <input
              ...
              className="w-full accent-[#66CDAA] cursor-pointer"
            />
          </div>
      ...
      >
        <div className="space-y-3 text-[10px] text-center">
          ...
          <div className="flex gap-2 pt-2">
            ...
            <button onClick={handleConfirmToggleStatus} className="flex-1 py-2 bg-[#66CDAA] hover:bg-[#4FBF99] text-white rounded-full font-bold cursor-pointer shadow-sm transition">
              Ya, Konfirmasi
            </button>
          </div>
        </div>
