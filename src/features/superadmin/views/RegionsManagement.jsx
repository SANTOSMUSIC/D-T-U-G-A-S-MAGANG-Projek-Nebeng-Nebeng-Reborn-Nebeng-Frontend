    ...
    <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 space-y-6 min-h-screen font-['Inter']">
      ...
      <div className="bg-white p-5 sm:p-6 rounded-2xl shadow-sm border border-neutral-200 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-[10px] sm:text-[11px] text-neutral-400 mt-0.5">
            Tambah, ubah, dan atur detail status operasional platform.
          </p>
        </div>
      ...
      <div className="bg-white p-4 rounded-2xl shadow-sm border border-neutral-200 flex items-center justify-between gap-3">
        ...
        <div className="text-[10px] font-semibold text-neutral-400 px-2">
          Total: <span className="font-bold text-neutral-800">
              ...
              <div key={region.id} className="p-4 space-y-3">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2.5">
                    ...
                    <div className="p-2 bg-[#66CDAA]/10 text-[#66CDAA] rounded-xl shrink-0">
                      <MapPin size={14} />
                    </div>
                ...
                <div className="flex items-center justify-end gap-1.5 pt-2">
                  ...
                  <button
                    ...
                    className="p-1.5 bg-[#66CDAA]/10 text-[#66CDAA] rounded-lg"
                  >
                    <Eye size={13} />
                  </button>
                  ...
                  <button
                    onClick={() => setRegionToToggle(region)}
                    ...
                    <td className="py-3.5 px-5">
                      <div className="flex items-center space-x-2.5">
                        ...
                        <div>
                          ...
                          <div className="text-[8px] font-bold text-neutral-400 font-mono">
                            {region.code}
                          </div>
                        </div>
        ...
        <form onSubmit={handleSubmitForm} className="space-y-3 text-[10px]">
          ...
          <div className="space-y-1">
            ...
            <input
              type="text"
              required
              placeholder="Misal: REG-DIY"
              value={formData.code}
              onChange={(e) =>
                setFormData({...formData, code: e.target.value})
              }
              className="w-full bg-neutral-50 border border-neutral-200 rounded-xl px-3 py-2 text-[10px] font-medium font-mono"
            />
          </div>
      ...
      >
        <div className="space-y-3 text-[10px] text-center">
          ...
          <p className="text-neutral-600">
            ...
            {regionToToggle?.isActive
              ? 'menonaktifkan'
              : 'mengaktifkan'
            } wilayah{' '}
            <strong>{regionToToggle?.name}</strong>?
          </p>
