                  ...
                  return (
                    <tr key={admin.id} className="hover:bg-gray-50/50">
                      <td className="py-3.5 px-5">
                        ...
                        <div className="text-[8px] font-bold text-[#66CDAA] font-mono">ID: {String(admin.id)}</div>
                      </td>
                      ...
                      <td className="py-3.5 px-5">
                        <div className="flex items-center justify-center gap-1.5">
                          <button onClick={() => { setSelectedAdmin(admin); setIsDetailModalOpen(true); }} className="p-1.5 bg-[#66CDAA]/10 text-[#66CDAA] rounded-lg cursor-pointer">
                            <Eye size={13} />
                          </button>
        ...
        <div className="space-y-3 text-[10px]">
          <div className="bg-neutral-50 p-3 rounded-xl border border-neutral-200 space-y-2">
            ...
            <div className="flex justify-between">
              ...
              <span className="font-bold text-[#66CDAA]">{selectedAdmin ? getRegionName(selectedAdmin) : '-'}</span>
            </div>
            <div className="flex justify-between">
          ...
          <button
            ...
            className="w-full py-2 bg-[#66CDAA] hover:bg-[#4FBF99] text-white text-[10px] font-bold rounded-full cursor-pointer transition shadow-sm"
          >
            Tutup
          </button>
        </div>
      ...
      >
        <form onSubmit={handleSubmitForm} className="space-y-3 text-[10px]">
          ...
          <div className="flex items-center justify-end gap-2 pt-3">
            ...
            <button type="submit" className="px-4 py-2 text-[10px] font-bold text-white bg-[#66CDAA] hover:bg-[#4FBF99] rounded-full flex items-center gap-1 cursor-pointer shadow-sm transition">
              <Save size={13} /> Simpan
            </button>
          </div>
        </form>
