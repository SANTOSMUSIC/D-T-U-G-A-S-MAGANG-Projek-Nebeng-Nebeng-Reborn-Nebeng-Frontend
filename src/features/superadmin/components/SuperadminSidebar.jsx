...
export default function SuperadminSidebar({ activeMenu = 'Dashboard', onMenuSelect, onLogout }) {
  ...
  return (
    <>
      <aside className="w-64 h-screen bg-gradient-to-b from-[#322C85] via-[#B019B8] to-[#FC156A] flex flex-col justify-between p-6 text-white fixed left-0 top-0 shadow-xl overflow-y-auto z-30">
        <div>
          {/* Logo Brand */}
