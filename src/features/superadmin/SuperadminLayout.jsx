...
export default function SuperadminLayout() {
  ...
  return (
    <div className="relative flex min-h-screen bg-neutral-100 overflow-hidden font-['Inter']">
      <div className="pointer-events-none absolute -top-24 -left-24 w-104 h-104 bg-[#66CDAA]/50 rounded-full blur-[110px] z-0"></div>
      <div className="pointer-events-none absolute top-1/2 -right-32 w-[24rem] h-96 bg-[#66CDAA]/60 rounded-full blur-[100px] z-0"></div>
