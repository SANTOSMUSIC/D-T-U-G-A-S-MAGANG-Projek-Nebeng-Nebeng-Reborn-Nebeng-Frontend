...
export default function MitraProfileModal({ isOpen, onClose, profile, onSettingsClick }) {
  ...
  const fields = [
    { icon: Mail, label: 'Email', value: savedProfile.email || 'Belum ada email terdaftar' },
    { icon: Phone, label: 'No. Telepon', value: savedProfile.phone || '-' },
    { icon: Car, label: 'Kendaraan', value: kendaraan },
    { icon: MapPin, label: 'Alamat', value: savedProfile.address || '-' },
  ];
