...
export default function AuthLayout({ children, title, subtitle, badgeText = "VERIFIED SECURITY SYSTEM" }) {
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center bg-neutral-100 p-4 md:p-8 overflow-hidden font-['Inter']">
      ...
      <div className="pointer-events-none absolute -top-32 -left-32 w-[28rem] h-[28rem] md:w-[34rem] md:h-[34rem] bg-[#66CDAA]/60 rounded-full blur-[100px]"></div>
      <div className="pointer-events-none absolute -bottom-32 -right-32 w-[28rem] h-[28rem] md:w-[34rem] md:h-[34rem] bg-[#66CDAA]/60 rounded-full blur-[100px]"></div>
      ...
      <div className="relative z-10 w-full max-w-5xl bg-white rounded-[24px] shadow-sm shadow-neutral-200 border border-neutral-100 overflow-hidden flex flex-col md:flex-row md:min-h-[600px] md:max-h-[90vh]">
        ...
        <div className="relative w-full md:w-1/2 m-3 md:m-4 rounded-[18px] overflow-hidden bg-gradient-to-b from-[#66CDAA]/10 to-[#66CDAA]/30 shrink-0 flex flex-col justify-between">
